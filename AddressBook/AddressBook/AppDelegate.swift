// AppDelegate.swift
// App entry point generated by Xcode
import UIKit
import CoreData
...
class AppDelegate: UIResponder, UIApplicationDelegate,
    ...
    func application(application: UIApplication,
        ...
        let masterNavigationController =
            splitViewController.viewControllers[0] as!
            UINavigationController
        let controller = masterNavigationController.topViewController as!
    ...
    // ADDED the check for InstructionsViewController
    func splitViewController(splitViewController: UISplitViewController,
        ...
        ontoPrimaryViewController primaryViewController:UIViewController)
            -> Bool {
        if let secondaryAsNavController =
            ...
            if let topAsDetailController =
                ...
                if topAsDetailController.detailItem == nil {
                    ...
                    // collapse by doing nothing; the secondary controller
                    // will be discarded.
                    return true
                }
    ...
    // Xcode generated code for Core Data support
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store
        // file. This code uses a directory named "com.deitel.AddressBook"
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        // The managed object model for the application. This property is
        // not optional. It is a fatal error for the application not to be
        // able to find and load its model.
        let modelURL = NSBundle.mainBundle().URLForResource("AddressBook",
            withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        // implementation creates and return a coordinator, having added 
        // the store for the application to it. This property is optional 
        // since there are legitimate error conditions that could cause 
        ...
        let url =
            self.applicationDocumentsDirectory.URLByAppendingPathComponent(
                "AddressBook.sqlite")
    ...
    lazy var managedObjectContext: NSManagedObjectContext? = {
        // Returns the managed object context for the application (which 
        // is already bound to the persistent store coordinator for the 
        // application.) This property is optional since there are 
        // legitimate error conditions that could cause the creation of 
        // the context to fail.
        ...
        if let moc = self.managedObjectContext {
            ...
            if moc.hasChanges {
                do {
                    ...
                    // error appropriately. abort() causes the application to 
                    // generate a crash log and terminate. You should not use 
                    // this function in a shipping application, although it 
