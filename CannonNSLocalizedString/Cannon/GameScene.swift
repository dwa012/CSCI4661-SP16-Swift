...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func createLabels() {
        ...
        timeRemainingLabel.text = NSLocalizedString("Time remaining:",
            comment: "Text of the timeRemainingLabel")
    ...
    override func update(currentTime: CFTimeInterval) {
        ...
        secondsLabel.text =
            String(format: NSLocalizedString("%.1f seconds",
                comment: "Formatted number of seconds remaining"), timeLeft)
