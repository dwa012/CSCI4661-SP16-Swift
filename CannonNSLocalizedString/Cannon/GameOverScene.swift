...
class GameOverScene: SKScene {
    ...
    init(size: CGSize, won: Bool, time: CFTimeInterval) {
        ...
        gameOverLabel.text = (won ?
            NSLocalizedString("You Win!", comment: "String indicating that the user won") :
            NSLocalizedString("You Lose", comment: "String indicating that the user lost"))
        ...
        elapsedTimeLabel.text =
            String(format: NSLocalizedString("Elapsed Time: %.1f seconds",
                    comment: "String displaying formatted elapsed time"), time)
        ...
        newGameLabel.text = NSLocalizedString("Begin New Game",
            comment: "String for a simulated new game button")
